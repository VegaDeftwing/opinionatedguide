...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bb44c517763a5a99c8d2cbf4a2f1888330687bf3328d723421e2bf5ce41fe8e1.js',function(){input.required=false;search();});}
