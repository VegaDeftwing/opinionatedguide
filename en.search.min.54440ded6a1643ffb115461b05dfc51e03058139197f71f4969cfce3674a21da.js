...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f32e8de7acdb642bba077155adb61b94edff8c3cc8f397ef0badf6ef9102fc5f.js',function(){input.required=false;search();});}
