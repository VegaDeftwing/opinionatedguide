...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.637d4692d6d7fdeb8f9f085102863090479314bfceacee7e69aaf4230a245c70.js',function(){input.required=false;search();});}
