...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aa9ec0d83fb023488fddb0c506fb7966f42cd873ad75b67d9e8e96871655fa1f.js',function(){input.required=false;search();});}
