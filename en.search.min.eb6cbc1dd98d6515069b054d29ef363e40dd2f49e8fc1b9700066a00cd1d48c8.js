...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.54f4e0b820d4587b46088a33d7dbb08afe300c7a8b04601e421240e351445011.js',function(){input.required=false;search();});}
