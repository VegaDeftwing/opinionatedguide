...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3344ce619fdc09b2761448e717366756ce9a7587c67231f62f7ebcfc587f2efa.js',function(){input.required=false;search();});}
