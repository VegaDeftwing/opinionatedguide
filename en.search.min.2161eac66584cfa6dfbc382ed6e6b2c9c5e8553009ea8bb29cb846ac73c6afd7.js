...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6419b3a901d3ed9592cbf79b42682ef194ccae1c6facddcccc9d433b96ab409c.js',function(){input.required=false;search();});}
