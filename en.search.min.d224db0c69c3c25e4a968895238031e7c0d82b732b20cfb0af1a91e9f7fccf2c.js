...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3093b6d0bdedcf337119c0eb656e436369ed10f8ddc3d72d79b3377896ebb2d2.js',function(){input.required=false;search();});}
