...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ded7dc620bdc28037f6220a8cf80d32dec46d9e5b54e7a81c6a4fc4a46156ed9.js',function(){input.required=false;search();});}
