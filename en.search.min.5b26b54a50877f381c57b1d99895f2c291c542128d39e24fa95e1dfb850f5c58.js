...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.72602b444cbc2e0d3437181297760587daa13c7821c730e40f59e6ffd9057628.js',function(){input.required=false;search();});}
