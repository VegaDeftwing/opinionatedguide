...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.10fbafaaf5a85116684fccde79da50dfe1a2337433aab17d827304e0f9a766b0.js',function(){input.required=false;search();});}
