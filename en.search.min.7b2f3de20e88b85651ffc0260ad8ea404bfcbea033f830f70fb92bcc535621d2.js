...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e83a45056518f6d940bfe9a666dd17a755e27b8e9e3beae15837804e54b4d91.js',function(){input.required=false;search();});}
