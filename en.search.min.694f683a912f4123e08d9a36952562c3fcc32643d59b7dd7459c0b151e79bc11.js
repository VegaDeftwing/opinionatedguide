...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8e0a642e7751ee30d21c290dacc3d603331ad51d2df5d7076a52a52afc92d2f6.js',function(){input.required=false;search();});}
