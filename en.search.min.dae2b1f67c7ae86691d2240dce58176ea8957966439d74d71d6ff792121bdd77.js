...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.530c4a7f93b0544d0372ee31d45a86cf2c40672706cf6147d6bf838d6f333f5e.js',function(){input.required=false;search();});}
