...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9e2dbef87bda47f570909caff058c9e9a9c8d83bddadbc7cccc3ec03a37f346a.js',function(){input.required=false;search();});}
