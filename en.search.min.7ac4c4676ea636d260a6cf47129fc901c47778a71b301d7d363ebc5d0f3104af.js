...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e278835d6e9ab14dd7a14316030f1b2b85752a0ca0a0378d15b4e4d8a4ec7dc6.js',function(){input.required=false;search();});}
