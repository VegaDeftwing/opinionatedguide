...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cecfe667d8d990566907510032105ae85406c0d234f3d21560f24c50586195b6.js',function(){input.required=false;search();});}
