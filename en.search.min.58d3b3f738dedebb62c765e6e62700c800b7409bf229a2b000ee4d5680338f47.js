...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bbc6dfb3e334ca3d8c8778589917648427e0a17679668db644be6b9d3c75b96c.js',function(){input.required=false;search();});}
