...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.345a60c51e342d758d9ddcdeb76840960b19410700c3dfcb40260cf696eda693.js',function(){input.required=false;search();});}
